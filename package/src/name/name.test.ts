...
describe('name', () => {
  ...
  it('Допускается дефис между буквами', () => {
    expect(name()('Иван-Иван')).toBeUndefined();
  });
  ...
  it('Допускается апостроф', () => {
    expect(name()('Д’‎Анжело')).toBeUndefined();
  });
  ...
  it('Допускается минимальное количество символов - 1', () => {
    expect(name()('и')).toBeUndefined();
  });

  it('Допускается максимальное количество символов - 200', () => {
    expect(name()('и'.repeat(200))).toBeUndefined();
  });

  it('Допускается максимальное количество символов - 200', () => {
    const error = name()('и'.repeat(201));
